...
import com.example.data.repository.GeminiDiagramService
...
class NoteVaultViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val geminiService = GeminiDiagramService()
    ...
    fun generateAiDiagram(prompt: String) {
        ...
        viewModelScope.launch {
            ...
            val result = geminiService.generateDiagramFromPrompt(prompt)
